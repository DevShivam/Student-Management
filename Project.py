...
#==================================Button_Frame===========================
        ...
        deletebtn=Button(btn_Frame,text="Delete",width=10,comman=self.delete_data).grid(row=0,column=2,padx=10,pady=10)
...
#====================TABLE FRAME========================
    ...
    def add_students(self):
        if self.Roll_No_var.get()=="" or self.name_var.get()=="":
            messagebox.showerror("FILL ALL !")
        else:
            con=pymysql.connect(host="localhost",user="root",password="root",database="stm", port=8889)
            cur=con.cursor()
